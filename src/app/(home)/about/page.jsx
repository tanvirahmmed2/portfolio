        ...
        {loading ? (
          ...
          <div className="space-y-16">
            ...
            <motion.div 
              ...
              className="p-8 md:p-10 border border-slate-200/80 rounded-3xl bg-white/70 backdrop-blur-xl flex flex-col md:flex-row gap-10 items-center justify-between shadow-xl shadow-slate-100"
            >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <motion.div 
                  ...
                  className="p-6 md:p-8 border border-slate-200 bg-slate-50/30 rounded-2xl hover:border-violet-500/40 hover:bg-white hover:shadow-lg transition-all duration-300 relative group overflow-hidden"
                >
                ...
                <motion.div 
                  variants={itemVariants}
                  className="p-6 md:p-8 border border-slate-200 bg-slate-50/30 rounded-2xl hover:border-indigo-500/40 hover:bg-white hover:shadow-lg transition-all duration-300 relative group overflow-hidden"
                >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <motion.div 
                  variants={itemVariants}
                  className="p-6 border border-slate-200/80 bg-white rounded-2xl space-y-4 hover:shadow-md hover:border-slate-300 transition-all duration-300"
                >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <motion.div 
                  variants={itemVariants}
                  className="p-6 border-l-4 border-violet-500 bg-slate-50 rounded-r-2xl space-y-2.5"
                >
                ...
                <motion.div 
                  variants={itemVariants}
                  className="p-6 border-l-4 border-indigo-500 bg-slate-50 rounded-r-2xl space-y-2.5"
                >
                ...
                <motion.div 
                  variants={itemVariants}
                  className="p-6 border-l-4 border-fuchsia-500 bg-slate-50 rounded-r-2xl space-y-2.5"
                >
            ...
            {settings?.resumeUrl && (
              <motion.div 
                ...
                viewport={{ once: true, margin: "-100px" }}
                transition={{ duration: 0.6 }}
                className="p-6 sm:p-8 border border-slate-200 rounded-3xl bg-slate-50/60 backdrop-blur-md flex flex-col sm:flex-row items-center justify-between gap-6"
              >
