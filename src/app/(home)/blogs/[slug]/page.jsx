...
export default function BlogDetailPage({ params }) {
    ...
    return (
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center text-neutral-400">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-semibold tracking-wide text-neutral-400">Retrieving article details...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center text-neutral-400 p-6">
        <div className="max-w-md w-full text-center space-y-4">
          ...
          <p className="text-neutral-500 text-xs">{error || 'Unable to locate article'}</p>
          <div className="pt-2">
            <Link
              href="/blogs"
  ...
  return (
    <article className="min-h-screen bg-neutral-950 py-24 px-6 sm:px-8 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-4 text-[9px] font-bold text-neutral-500 uppercase tracking-widest">
            {blog.created_at && (
              <span>
          ...
          {blog.summary && (
            <p className="text-xs sm:text-sm text-neutral-450 leading-relaxed italic border-l-2 border-violet-500/20 pl-4 py-1">
              {blog.summary}
            </p>
          )}
        </div>
        ...
        {/* Cover Photo */}
        {blog.image && (
          <div className="relative aspect-video w-full rounded-3xl overflow-hidden bg-neutral-950 border border-neutral-900 shadow-2xl">
            <img
              src={blog.image}
              alt={blog.title}
        ...
        <div className="prose prose-invert prose-sm max-w-none prose-neutral prose-p:leading-relaxed prose-headings:font-bold prose-headings:tracking-tight prose-a:text-violet-400 hover:prose-a:text-violet-300 pt-4">
          <div
            ...
            className="text-xs sm:text-sm text-neutral-300 space-y-4 whitespace-normal"
          />
        </div>
