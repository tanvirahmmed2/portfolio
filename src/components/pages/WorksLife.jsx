      ...
      <section className="py-20 px-6 sm:px-8">
        <div className="max-w-3xl mx-auto space-y-6 animate-pulse">
          ...
          <div className="space-y-4">
            <div className="h-20 rounded-2xl"></div>
            <div className="h-20 rounded-2xl"></div>
          </div>
        </div>
      </section>
  ...
  return (
    <section className="py-20 px-6 sm:px-8 border-t">
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        {/* Timeline block */}
        <div className="space-y-6 relative before:absolute before:inset-y-2 before:left-[15px] before:w-[1px]">
          {works.map((work) => (
            <div key={work.id} className="relative pl-10 group">
              
              {/* Dot marker */}
              <div className="absolute left-[9px] top-2 w-[13px] h-[13px] border-2 border-violet-500 rounded-full group-hover:scale-120 transition-transform z-10"></div>
              
              <div className="p-5 border rounded-2xl transition-all duration-300 space-y-2">
                ...
                <p className="text-[11px] leading-relaxed pt-1 whitespace-pre-line">
                  {work.description}
                </p>
              </div>
