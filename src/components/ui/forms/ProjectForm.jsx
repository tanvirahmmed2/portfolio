    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl bg-neutral-900/10 p-2 sm:p-6 border border-neutral-900 rounded-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-neutral-400 uppercase tracking-wide">Project Title</label>
          <input
            type="text"
            value={title}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-neutral-400 uppercase tracking-wide">Live Demo Link</label>
          <input
            type="url"
            value={demoUrl}
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-neutral-400 uppercase tracking-wide">GitHub Repository Link</label>
          <input
            type="url"
            value={githubUrl}
      ...
      <div className="flex flex-col gap-1.5">
        <div className="flex justify-between items-center">
          <label className="text-xs font-bold text-neutral-400 uppercase tracking-wide">Short Project Summary</label>
          <span className="text-[10px] text-neutral-500 font-medium">{summary.length}/500 chars</span>
        </div>
        <textarea
          rows={3}
          maxLength={500}
          ...
          className="w-full bg-neutral-950 border border-neutral-800 rounded-xl px-4 py-2.5 text-sm text-white placeholder-neutral-600 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 transition-all duration-200 resize-none"
        />
      </div>

      {/* Description Content Editor */}
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-bold text-neutral-400 uppercase tracking-wide">Detailed Description</label>
      ...
      <div className="flex flex-col gap-2 bg-neutral-950/20 border border-neutral-800/80 p-4 rounded-xl">
        <label className="text-xs font-bold text-neutral-400 uppercase tracking-wide">Project Showcase Image</label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="flex items-center gap-3 bg-neutral-950/20 border border-neutral-800/80 p-3.5 rounded-xl">
          ...
          />
          <label htmlFor="isFeatured" className="text-xs font-bold text-neutral-300 uppercase tracking-wide cursor-pointer select-none">
